...
public class RandomCachedNestedLeakingScriptRunner implements Runnable {
	...
	public RandomCachedNestedLeakingScriptRunner(ScriptRandomizer randomizer, ScriptCache scriptCache) {
